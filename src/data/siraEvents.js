...
export  const siraEvents = [
  ...
  },
  {
    ...
    versets: null,
    sources: [
      "<strong>Hadith (Transport des pierres) :</strong> <a href='https://sunnah.com/bukhari:3829' target='_blank' class='source-link'>Ṣaḥīḥ al-Bukhārī 3829</a> et <a href='https://sunnah.com/muslim:340a' target='_blank' class='source-link'>Ṣaḥīḥ Muslim 340a</a> — Récit de Jâbir ibn 'Abdillâh sur la participation du Prophète ﷺ.",
      "<strong>Hadith (Arbitrage de la Pierre Noire) :</strong> <a href='https://hadithunlocked.com/ahmad:15504' target='_blank' class='source-link'>Musnad Ahmad 15504 (HadithUnlocked)</a> — Récit de l'arbitrage pacifique avec le vêtement partagé.",
  ...
  },
  {
    ...
    recit:
      "Pendant les trois premières années, la prédication se fait de manière <strong>sélective et individuelle</strong> (Da'wa privée). En réalité, l'Islam n'était pas un secret absolu : les notables de Quraysh savaient que Muhammad ﷺ propageait un nouveau message et que des fidèles le rejoignaient, mais ils restaient indifférents et ne réagissaient pas, car cela ne menaçait pas encore frontalement leurs idoles, leur prestige tribal et leurs intérêts commerciaux.<br><br>L'objectif était de bâtir un noyau dur, éduqué et spirituellement inébranlable. Pour réunir les premiers croyants (environ 60 personnes), leur enseigner le Coran et prier à l'abri des provocations, le Prophète ﷺ choisit la maison du jeune <strong>Al-Arqam ibn Abî Al-Arqam</strong>.<br><br><div class='strategic-box'><div class='strategic-header'><span class='strategic-badge'>Génie Tactique</span><strong>Le Contexte Stratégique du choix de Dâr Al-Arqam :</strong></div><ul class='strategic-list'><li><span class='strategic-bullet'>🛡️</span><div><strong>La tribu rivale :</strong> Al-Arqam était issu des <em>Banû Makhzûm</em>, le clan d'Abû Jahl et rival acharné des Banû Hâshim. Jamais les Quraysh n'auraient imaginé que le Prophète ﷺ établisse son quartier général en plein cœur du territoire ennemi.</div></li><li><span class='strategic-bullet'>👤</span><div><strong>Le profil du propriétaire :</strong> Al-Arqam n'avait qu'environ 16 ans. Les notables mecquois surveillaient les domiciles des hommes influents et âgés (comme Abû Bakr), mais ne se méfiaient pas d'un adolescent.</div></li><li><span class='strategic-bullet'>📍</span><div><strong>L'emplacement géographique :</strong> La maison était située sur le mont Safâ, un lieu central et extrêmement fréquenté. Les allées et venues des Compagnons se fondaient naturellement dans la masse des pèlerins et des passants.</div></li></ul></div>",
    personnages: [
      {
  ...
  },
  {
    ...
    recit:
      "Le Prophète ﷺ marche plus de 80 km à pied jusqu'à Ta'if (tribu Thaqif) pour y chercher protection. Les chefs le rejettent avec mépris et excitent la foule pour le lapider. Blessé, ses sandales remplies de sang, il ﷺ trouve refuge à l'ombre d'un verger et prononce cette invocation poignante :<br><br><blockquote class='doua-quote'><em>« Ô Allah ! C’est à Toi que je me plains de ma faiblesse, de mon manque de ressources et de mon insignifiance aux yeux des hommes. Ô le plus Miséricordieux des miséricordieux ! Tu es le Seigneur des opprimés et Tu es mon Seigneur. À qui m’abandonnes-Tu ? À un étranger hostile qui me repousse avec dureté, ou à un ennemi à qui Tu as confié mon sort ? Tant que Tu n'es pas en colère contre moi, rien ne m'importe, mais Ta bienveillance et Ta protection me sont plus vastes. Je cherche refuge auprès de la lumière de Ton Visage — qui illumine les ténèbres et préserve les affaires de ce bas-monde et de l’au-delà — contre le fait que Ton courroux ne s'abatte sur moi ou que Ta colère ne me frappe. C'est à Toi que revient le repentir jusqu'à ce que Tu sois satisfait, et il n'y a de force ni de puissance qu'en Toi. »</em></blockquote><br>L'Archange Jibrîl et l'Ange des montagnes lui proposent alors d'écraser la ville sous les deux monts, mais le Prophète ﷺ refuse par pure miséricorde : <em>« J'espère plutôt qu'Allah fera émerger de leur descendance des croyants qui L'adoreront Seul sans rien Lui associer »</em>.<br><br>Sur le chemin du retour, dans la vallée de Nakhla, un groupe de Djinns s'arrête, écoute le Coran récité durant sa prière et embrasse la foi.", 
    personnages: [
      {
        nom: "'Addas",
